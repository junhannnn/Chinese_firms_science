...
# CONFIG
# ============================
CSV_PATH = "04_canonical_log_CN.csv"
HOST = os.environ.get("OLLAMA_HOST", "http://localhost:11434")  # Ollama-compatible chat endpoint base
MODEL = "llama3.3:70b"

OUT_JSON = "05_affiliation_clusters_CN.json"
OUT_RESULTS_CSV = "05_llm_results_CN.csv"
OUT_PAIRS_CSV = "05_candidate_pairs_before_llm_CN.csv"  # saved BEFORE LLM calls
