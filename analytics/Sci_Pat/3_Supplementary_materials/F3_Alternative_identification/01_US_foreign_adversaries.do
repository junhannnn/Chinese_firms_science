...
Script:  1_US_foreign_adversaries.do

Purpose:
  Convert the country-level U.S. foreign-adversary classification workbook from
  long to wide form and create indicators for eight sanction or export-control
  categories.

Main input (relative to the release root):
  - dataset/Miscellaneous/US_foreign_adversaries.xlsx

Main output (relative to the release root):
  - dataset/Miscellaneous/US_foreign_adversaries_dropdup.xlsx

Notes:
  The supplementary runner executes this script from the release root because
  the executable paths below are release-root relative.
*******************************************************************************/

* ==============================================================================
* 1. Import the classification data and assign category ranks
* ==============================================================================
...
* ==============================================================================
* 2. Reshape to one record per country and create category indicators
* ==============================================================================
...
* ==============================================================================
* 3. Label the indicators and export the country-level workbook
* ==============================================================================
